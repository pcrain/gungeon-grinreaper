            ...
            npcobj = FancyNPC.Setup<Bombo>(
                ...
                animationData : new List<SimpleAnimationData>() {
                   new SimpleAnimationData("idler",3, new List<string>() {
                       "TheGrinReaper/Resources/NPCSprites/GrinReaper/grin-allsprites3",
                       "TheGrinReaper/Resources/NPCSprites/GrinReaper/grin-allsprites4",
                       }),
                   new SimpleAnimationData("talker",5, new List<string>() {
                       "TheGrinReaper/Resources/NPCSprites/GrinReaper/grin-allsprites1",
                       "TheGrinReaper/Resources/NPCSprites/GrinReaper/grin-allsprites2",
                       }),
                   new SimpleAnimationData("sad",3, new List<string>() {
                       "TheGrinReaper/Resources/NPCSprites/GrinReaper/grin-allsprites5",
                       "TheGrinReaper/Resources/NPCSprites/GrinReaper/grin-allsprites6",
                       }),
                   new SimpleAnimationData("point",3, new List<string>() {
                       "TheGrinReaper/Resources/NPCSprites/GrinReaper/grin-allsprites9",
                       "TheGrinReaper/Resources/NPCSprites/GrinReaper/grin-allsprites10",
                       })
                }
